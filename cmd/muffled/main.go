...
import (
	...
	"hack.moontide.ink/lukas/muffled/internal/polling"
	"hack.moontide.ink/lukas/muffled/internal/routing"
	"hack.moontide.ink/lukas/muffled/internal/widget"
)
...
func main() {
	...
	app := &cli.Command{
		...
		Action: func(context.Context, *cli.Command) error {
			...
			slog.Info("starting web server", "address", c.Listen)
